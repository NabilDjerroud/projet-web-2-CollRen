            ...
            <section className="py-10">
                <div className="container mx-auto grid grid-cols-3 gap-8">
                    <div className="col-span-1">
                        <div className="py-56 bg-white p-4 rounded-lg shadow-md mb-8 max-h-full" style={{ backgroundImage: 'url(\'/imgs/tucson.jpg\')', backgroundSize: 'cover',
                backgroundPosition: 'center', }}>
                            <p className="text-lg font-bold">Voiture à moins de 12000$</p>
                        </div>
                        <div className="py-56 bg-white p-4 rounded-lg shadow-md" style={{ backgroundImage: 'url(\'/imgs/tucson.jpg\')' }}>
                            <p className="text-lg font-bold">Voiture à moins de 15000$</p>
                        </div>
                    </div>
                    <div className="col-span-1">
                        <div className=" bg-white p-4 col-span-2 rounded-lg shadow-md mb-8" style={{ backgroundImage: 'url(\'/imgs/legende.jpg\')', backgroundSize: 'cover',
                backgroundPosition: 'center', }}>
                            <p className="text-lg font-bold">Voitures iconique</p>
                        </div>
                    </div>
                    <div className="col-span-1">
                        <div className="bg-white p-4 rounded-lg shadow-md mb-8" style={{ backgroundImage: 'url(\'/imgs/tucson.jpg\')' }}>
                            <p className="text-lg font-bold">Voiture à moins de 20000$</p>
                        </div>
                        <div className="bg-white p-4 rounded-lg shadow-md" style={{ backgroundImage: 'url(\'/imgs/tucson.jpg\')' }}>
